...
CREATE TABLE `attachments`  (
  ...
  `FileHash` char(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'SHA-256 文件指纹',
  `IsExternal` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否外链',
  `ExternalURL` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '外链原始地址',
  PRIMARY KEY (`AttachmentID`) USING BTREE,
  UNIQUE INDEX `StoredName`(`StoredName`) USING BTREE,
  UNIQUE INDEX `UK_Attachments_PostID_FileHash`(`PostID`, `FileHash`) USING BTREE,
