...
const { commentCreateGuard } = require('../middleware/riskControl');
 ...
 *         description: 评论发表成功
 */
router.post('/:articleId', auth, commentCreateGuard, [
 ...
 *         description: 评论树结构
 */
router.get('/:articleId/tree', optionalAuth, commentController.getCommentsTreeByArticle);
 ...
 *         description: 评论列表
 */
router.get('/:articleId', optionalAuth, commentController.getCommentsByArticle);
